...
class LSTMModel(nn.Module):
    ...
    # The forward method defines the forward pass of the model, i.e., how input flows through the layers
    def forward(self, x):
        ...
        # lstm_out[:, -1, :] extracts the hidden state from the last time step
        lstm_out = lstm_out[:, -1, :]
