...
#SBATCH --mem=64G
#SBATCH --time=6:00:00
#SBATCH --output=logs/slurm-eval-v3-%j.out
#SBATCH --error=logs/slurm-eval-v3-%j.err
...
CKPT="$REPO/saves/world_model_qwen2p5_3b_v3/final-model"
OUT="$REPO/results/eval_polymarket/v3.jsonl"
mkdir -p "$(dirname "$OUT")"
