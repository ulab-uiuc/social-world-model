#!/bin/bash
# v48: same recipe as v47 but Qwen3-4B, 4-GPU DDP.
...
CUDA_VISIBLE_DEVICES=$GPUS torchrun --nproc_per_node=4 --master_port=$PORT \
    ...
    --output-dir /mnt/data_from_server1/haofeiy2/swm_saves/forecaster_v48_predict_p_origstd_4b \
    ...
    > /home/haofeiy2/social-world-model/logs/fc_v48_predict_p_origstd_4b.log 2>&1
echo "v48 (4B) done"
