...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Train and evaluate the RAG Social Wisdom Model')
    
    # Data paths
    parser.add_argument('--train-data-path', type=str, default='../data/splitted_polymarket/polymarket_data_processed_Crypto_train.jsonl')
    parser.add_argument('--valid-data-path', type=str, default='../data/splitted_polymarket/polymarket_data_processed_Crypto_dev.jsonl')
    parser.add_argument('--test-data-path', type=str, default='../data/splitted_polymarket/polymarket_data_processed_Crypto_test.jsonl')
    parser.add_argument('--corpus-data-path', type=str, default='../data/splitted_polymarket/polymarket_data_processed_Crypto_train.jsonl')
    ...
    parser.add_argument('--target-modules', type=str, nargs='+', default=['q_proj', 'v_proj'])
