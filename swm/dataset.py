...
class PolyMarketDataset(Dataset):
    def __init__(
        ...
        self.datapoints = []
        self._create_datapoints(markets, similar_markets_dict, window_size, max_series_length)

    def _create_datapoints(self, markets, similar_markets_dict, window_size, max_series_length):
        for market in tqdm(markets):
            ...
            for outcome, series in market.time_series.items():
                ...
                for i in range(len(series) - window_size):
                    ...
                    encodings = self.tokenizer(prompt, padding=True, truncation=True, return_tensors='pt')
