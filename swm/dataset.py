            ...
            for outcome, series in market.time_series.items():
                ...
                for i in range(len(daily_series) - window_size):
                    ...
                    for sim_market in similar_markets:
                        if (
                            sim_market.market_id == market.market_id
                            or outcome not in sim_market.time_series
                        ):
                            continue

                        sim_series = self._filter_midnight_points(
                            sim_market.time_series[outcome]
                        )
                        window_series = []
