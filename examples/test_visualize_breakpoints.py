    ...
    if breakpoints:
        ...
        for bp in breakpoints:
            ...
            ax.annotate(
                ...
                fontweight='bold',
                ha='center',
                va='bottom' if after['p'] > before['p'] else 'top',
            )
...
def main():
    ...
    parser.add_argument(
        '--save_dir', type=str, default=None, help='Directory to save plots (optional)'
    )
    parser.add_argument(
        '--num_samples',
        type=int,
