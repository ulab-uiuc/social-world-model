...
def parse_args():
    ...
    parser.add_argument(
        '--input_file',
        default='../data/processed_polymarket/polymarket_data_processed_Election.jsonl',
        help='Input JSONL file with processed Polymarket data',
    )
    parser.add_argument(
        '--output_dir',
        default='../data/polymarket_breakpoint_news',
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help='Days after breakpoint to crawl (default: 0)',
    )
    parser.add_argument(
        '--max_pages',
        type=int,
