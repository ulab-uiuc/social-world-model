...
python examples/step5_split_data.py \
    --input_file "${DATA_DIR}/processed_kalshi_v2_0102/kalshi_data_processed_with_news.jsonl" \
    --output_dir "${DATA_DIR}/splitted_kalshi_v2_0102" \
    --cutoff_date $CUTOFF

# Polymarket
python examples/step5_split_data.py \
    --input_file "${DATA_DIR}/processed_polymarket_v2_0102/polymarket_data_processed_with_news.jsonl" \
